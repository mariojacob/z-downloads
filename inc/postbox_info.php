        ...
        <table class="form-table">
            <tbody>
                <tr valign="top">
                    ...
                    <td valign="middle">
                        <?= esc_attr($zdm_options['version']) ?> <a href="https://code.urban-base.net/z-downloads/release-notes/?utm_source=zdm_backend" target="_blank" title="<?= esc_html__('Release notes', 'zdm') ?>"><?= esc_html__('release notes', 'zdm') ?> <span class="material-icons-round zdm-md-1">open_in_new</span></a>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td valign="middle">
                        ...
                        <a href="https://code.urban-base.net/z-downloads/shortcodes/?utm_source=zdm_backend" target="_blank" title="<?= esc_html__('Shortcodes', 'zdm') ?>"><?= esc_html__('Shortcodes', 'zdm') ?> <span class="material-icons-round zdm-md-1">open_in_new</span></a>,
                        <a href="https://code.urban-base.net/z-downloads/farben/?utm_source=zdm_backend" target="_blank" title="<?= esc_html__('Colors', 'zdm') ?>"><?= esc_html__('Colors', 'zdm') ?> <span class="material-icons-round zdm-md-1">open_in_new</span></a>,
                        <a href="https://wordpress.org/plugins/z-downloads/#faq" target="_blank" title="<?= esc_html__('FAQ', 'zdm') ?>"><?= esc_html__('FAQ', 'zdm') ?> <span class="material-icons-round zdm-md-1">open_in_new</span></a>
                    </td>
                </tr>
            </tbody>
        </table>
